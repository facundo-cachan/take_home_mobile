...
const Orientation = () => Dimensions.addEventListener('change', ({ window: { width, height } }) => {
  if (width < height) {
    return 'portrait';
  }
  return 'landscape';
...
const getFontLineHeight = (fontSize: number) => fontSize * LINE_HEIGHT_SCALE_FACTOR;

export {
  Orientation, getFontLineHeight, height, horizontalScale, heightPercentageToDP as hp,
  moderateScale, verticalScale, width,
